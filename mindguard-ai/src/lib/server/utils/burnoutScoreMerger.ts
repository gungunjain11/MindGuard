import type { UnifiedBurnoutScore, RiskLabel } from "../types/ai";

export const mergeRiskScores = (structuredScore: number, aiRiskLevel: "low" | "medium" | "high"): UnifiedBurnoutScore => {
