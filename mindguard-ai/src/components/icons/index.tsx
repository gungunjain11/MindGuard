...
export function BrainIcon({ size = 24, className = "", color = "currentColor", style = {} }: { size?: number, className?: string, color?: string, style?: any }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} style={style} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
